    ...
    <div className="flex justify-center items-center h-screen">
      <div className="flex space-x-4">
        {productData.map((product, index) => (
          <div
            key={index}
            className="bg-white p-4 sm:p-8 max-w-xs relative hover:border border-black rounded-lg transition-transform transform hover:scale-105 hover:border transition-border duration-300" // Combina ambas animaciones
          >
            <div className="relative">
              ...
              />
              {/* Aplicamos un reflejo simulado con una sombra en la parte inferior */}
